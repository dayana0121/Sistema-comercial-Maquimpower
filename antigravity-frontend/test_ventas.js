...
// Yo dejo este endpoint alineado al backend actual para que las pruebas no peguen a un proyecto viejo.
const API_URL = 'http://localhost/Sistema-comercial-Maquimpower/antigravity-backend/api';
