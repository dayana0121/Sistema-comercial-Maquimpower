<?php
require_once __DIR__ . '/libraries/libraries/Numletras.php';
require_once __DIR__ . '/libraries/libraries/Variables_diversas_model.php';
require_once __DIR__ . '/libraries/libraries/efactura.php';

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['datosJSON'])) {
    ...
    $nombre = __DIR__ . "/files/facturacion_electronica/XML/" . $nombre_archivo . ".xml";
